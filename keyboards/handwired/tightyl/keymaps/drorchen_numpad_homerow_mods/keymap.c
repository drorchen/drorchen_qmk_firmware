...
#define DC_LALT LM(RAISE, MOD_LALT)
#define DC_TAB MT(MOD_LSFT, KC_TAB)
#define DC_SPACE MT(MOD_LCTL, KC_SPACE)
...
#define DC_TMX 0x999
#define DC_SHIFT 0x1000

bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case DC_TMX:
            if (record->event.pressed) {
                // when keycode DC_TMX is pressed
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_SHIFT_TAB] = ACTION_TAP_DANCE_DOUBLE(DC_TAB, DC_SHIFT),
};
 ...
 */
    [QWERTY] = LAYOUT(
      ...
      _______,   KC_Z,   KC_X,     KC_C,    KC_V,       KC_B,                                       KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, _______,
                         DC_TMX,   KC_LGUI, DC_LALT,    DC_TAB, DC_SPACE,        KC_BSPC, DC_ENT, DC_ESC,  KC_DEL,  KC_QUOT
    ),
 ...
 */
    [NUMBERS] = LAYOUT(
      ...
      _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,    KC_PERC,                                       KC_TAB,  KC_1,    KC_2,    KC_3,    KC_BSLS, _______,
 ...
 */
    [RAISE] = LAYOUT(
      _______, _______, _______, _______, _______,   _______,                                       _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______,   _______,                                       _______, _______, _______, _______, _______, _______,
      _______, _______, KC_ENT,  KC_LSFT, KC_TAB,    _______,                                       _______, _______, _______, _______, _______, _______,
      _______, _______, _______, _______, _______,   _______,                                       _______, _______, _______, _______, _______, _______,
                        RESET,   _______, _______,   _______, _______,                    KC_RCTL,  KC_RSFT, KC_RALT, _______, _______
    ),
};
